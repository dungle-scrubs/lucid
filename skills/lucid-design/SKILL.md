---
name: lucid-design
description: Use this skill to generate well-branded interfaces and assets for Lucid, either for production or throwaway prototypes/mocks/etc. Contains essential design guidelines, colors, type, fonts, assets, and UI kit components for prototyping. Triggers: Lucid design, Lucid branding, Lucid UI kit, style a Lucid artifact, Lucid colors and type.
---
...
- `assets/` - wordmark, lucid-mark icon, flow diagram SVG
- `preview/` - Design-System-tab specimen cards (one concept per card)
- `ui_kits/editor/` - clickable React recreation of the Lucid Editor chrome
...
4. Reference `assets/lucid-wordmark.svg` for the brand mark; do not redraw it.
