...
export const on = (root: Page | FrameLocator | Locator) => ({
  ...
  createAuthFailure: (): Locator => root.locator(hook("create-auth-failure")),
  ...
  artifactOutlinePanel: (): Locator => root.locator(hook("artifact-outline-panel")),
  artifactOutlineRail: (): Locator => root.locator(hook("artifact-outline-rail")),
  ...
  surfaceControlLayer: (): Locator => root.locator(hook("surface-control-layer")),
  surfaceOutlineSlot: (): Locator => root.locator(hook("surface-outline-slot")),
  surfaceRegion: (): Locator => root.locator(hook("surface-region")),
  ...
  toggleFocus: (): Locator => root.locator(hook("toggle-focus")),
  toggleFocusAll: (): Locator => root.locator(hook("toggle-focus-all")),
