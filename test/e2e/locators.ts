...
export const on = (root: Page | FrameLocator | Locator) => ({
  ...
  scopeClear: (): Locator => root.locator(hook("scope-clear")),
  scopeLabel: (): Locator => root.locator(hook("scope-label")),
